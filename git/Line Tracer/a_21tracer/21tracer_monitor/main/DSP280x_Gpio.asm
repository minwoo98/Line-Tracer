...
;	..\Compiler\bin\opt2000.exe C:\Users\agdll\AppData\Local\Temp\TI83210 C:\Users\agdll\AppData\Local\Temp\TI8324 
;	..\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -I..\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\agdll\AppData\Local\Temp\TI8322 --template_info_file C:\Users\agdll\AppData\Local\Temp\TI8326 --object_file DSP280x_Gpio.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
	.global	_InitGpio
...
;*** 107	-----------------------    GpioCtrlRegs.GPAMUX2.all = 0x5020515uL;
;*** 118	-----------------------    GpioCtrlRegs.GPBMUX1.all = 0uL;
;*** 161	-----------------------    GpioCtrlRegs.GPADIR.all = 0x2ccdffffuL;
