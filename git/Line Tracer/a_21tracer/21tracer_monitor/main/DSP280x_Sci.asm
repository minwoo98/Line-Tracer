...
;	..\Compiler\bin\opt2000.exe C:\Users\agdll\AppData\Local\Temp\TI74010 C:\Users\agdll\AppData\Local\Temp\TI7404 
;	..\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -I..\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\agdll\AppData\Local\Temp\TI7402 --template_info_file C:\Users\agdll\AppData\Local\Temp\TI7406 --object_file DSP280x_Sci.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
	.global	_SCIx_TxChar
...
DW$6	.dwtag  DW_TAG_subprogram, DW_AT_name("SCIx_TxChar"), DW_AT_symbol_name("_SCIx_TxChar")
	...
	.dwattr DW$6, DW_AT_begin_line(0x4c)
	.dwattr DW$6, DW_AT_begin_column(0x06)
	.dwpsn	"DSP280x_Sci.c",77,1
...
;***	-----------------------g2:
;*** 80	-----------------------    if ( !(*((volatile struct _SCICTL2_BITS *)&SciaRegs+4L)&0x80u) ) goto g2;
	.dwpsn	"DSP280x_Sci.c",80,11
        MOVW      DP,#_SciaRegs+4
        TBIT      @_SciaRegs+4,#7       ; |80| 
        BF        L1,NTC                ; |80| 
        ; branchcc occurs ; |80| 
DW$L$_SCIx_TxChar$2$E:
;*** 81	-----------------------    SciaRegs.SCITXBUF = Data;
;*** 81	-----------------------    return;
	.dwpsn	"DSP280x_Sci.c",81,5
        MOV       @_SciaRegs+9,AL       ; |81| 
	.dwpsn	"DSP280x_Sci.c",82,1
        LRETR
        ; return occurs

DW$9	.dwtag  DW_TAG_loop
	.dwattr DW$9, DW_AT_name("C:\21tracer_monitor\main\DSP280x_Sci.asm:L1:1:1612335234")
	.dwattr DW$9, DW_AT_begin_file("DSP280x_Sci.c")
	.dwattr DW$9, DW_AT_begin_line(0x50)
	.dwattr DW$9, DW_AT_end_line(0x50)
DW$10	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$6, DW_AT_end_line(0x52)
...
DW$11	.dwtag  DW_TAG_subprogram, DW_AT_name("SCIx_TxString"), DW_AT_symbol_name("_SCIx_TxString")
	...
	.dwattr DW$11, DW_AT_begin_line(0x54)
	.dwattr DW$11, DW_AT_begin_column(0x06)
	.dwpsn	"DSP280x_Sci.c",85,1
...
;***	-----------------------g3:
;*** 88	-----------------------    if ( U$1 != 10 ) goto g7;
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
	.dwpsn	"DSP280x_Sci.c",88,9
        CMPB      AL,#10                ; |88| 
        BF        L4,NEQ                ; |88| 
        ; branchcc occurs ; |88| 
...
;***	-----------------------g5:
;*** 80	-----------------------    if ( !(*((volatile struct _SCICTL2_BITS *)&SciaRegs+4L)&0x80u) ) goto g5;  // [3]
	.dwpsn	"DSP280x_Sci.c",80,11
        MOVW      DP,#_SciaRegs+4
        TBIT      @_SciaRegs+4,#7       ; |80| 
        BF        L3,NTC                ; |80| 
...
;*** 81	-----------------------    SciaRegs.SCITXBUF = 13u;  // [3]
	.dwpsn	"DSP280x_Sci.c",81,5
        MOV       @_SciaRegs+9,#13      ; |81| 
...
;*** 92	-----------------------    Data = U$1;
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
	.dwpsn	"DSP280x_Sci.c",92,9
DW$L$_SCIx_TxString$5$E:
L5:    
DW$L$_SCIx_TxString$6$B:
;***	-----------------------g8:
;*** 80	-----------------------    if ( !(*((volatile struct _SCICTL2_BITS *)&SciaRegs+4L)&0x80u) ) goto g8;  // [3]
	.dwpsn	"DSP280x_Sci.c",80,11
        MOVW      DP,#_SciaRegs+4
        TBIT      @_SciaRegs+4,#7       ; |80| 
        BF        L5,NTC                ; |80| 
...
;*** 81	-----------------------    SciaRegs.SCITXBUF = Data;  // [3]
;*** 81	-----------------------    if ( U$1 = *(++Str) ) goto g3;  // [3]
;***	-----------------------g10:
;***  	-----------------------    return;
	.dwpsn	"DSP280x_Sci.c",81,5
        MOV       @_SciaRegs+9,AL       ; |81| 
...
DW$16	.dwtag  DW_TAG_loop
	.dwattr DW$16, DW_AT_name("C:\21tracer_monitor\main\DSP280x_Sci.asm:L2:1:1612335234")
	.dwattr DW$16, DW_AT_begin_file("DSP280x_Sci.c")
	.dwattr DW$16, DW_AT_begin_line(0x51)
	.dwattr DW$16, DW_AT_end_line(0x5d)
...
DW$21	.dwtag  DW_TAG_loop
	.dwattr DW$21, DW_AT_name("C:\21tracer_monitor\main\DSP280x_Sci.asm:L3:2:1612335234")
...
DW$23	.dwtag  DW_TAG_loop
	.dwattr DW$23, DW_AT_name("C:\21tracer_monitor\main\DSP280x_Sci.asm:L5:2:1612335234")
	.dwattr DW$23, DW_AT_begin_file("DSP280x_Sci.c")
	.dwattr DW$23, DW_AT_begin_line(0x50)
	.dwattr DW$23, DW_AT_end_line(0x5c)
...
;***	-----------------------g2:
;*** 70	-----------------------    if ( !(*((volatile struct _SCIRXST_BITS *)&SciaRegs+5L)&0x40u) ) goto g2;
	.dwpsn	"DSP280x_Sci.c",70,12
        MOVW      DP,#_SciaRegs+5
        TBIT      @_SciaRegs+5,#6       ; |70| 
        BF        L7,NTC                ; |70| 
        ; branchcc occurs ; |70| 
...
;*** 72	-----------------------    return (int)SciaRegs.SCIRXBUF.all;
	...
	.dwpsn	"DSP280x_Sci.c",74,1
        LRETR
        ; return occurs

DW$31	.dwtag  DW_TAG_loop
	.dwattr DW$31, DW_AT_name("C:\21tracer_monitor\main\DSP280x_Sci.asm:L7:1:1612335234")
	.dwattr DW$31, DW_AT_begin_file("DSP280x_Sci.c")
	.dwattr DW$31, DW_AT_begin_line(0x46)
	.dwattr DW$31, DW_AT_end_line(0x46)
DW$32	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$30, DW_AT_end_line(0x4a)
