...
;	..\Compiler\bin\opt2000.exe C:\Users\agdll\AppData\Local\Temp\TI41610 C:\Users\agdll\AppData\Local\Temp\TI4164 
;	..\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -I..\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\agdll\AppData\Local\Temp\TI4162 --template_info_file C:\Users\agdll\AppData\Local\Temp\TI4166 --object_file VFD.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
...
DW$7	.dwtag  DW_TAG_subprogram, DW_AT_name("VfdCtlRegInit"), DW_AT_symbol_name("_VfdCtlRegInit")
	...
	.dwattr DW$7, DW_AT_begin_line(0xab)
...
;*** 176	-----------------------    ((volatile unsigned *)C$2)[5] |= 0x400u;
;*** 177	-----------------------    ((volatile unsigned *)C$2)[3] |= 0x80u;
;*** 178	-----------------------    *((volatile struct _GPBDAT_BITS *)C$2+10L) |= 1u;
;*** 179	-----------------------    *(&GpioDataRegs+3L) |= 0x400u;
;*** 180	-----------------------    *((volatile struct _GPBDAT_BITS *)C$2+12L) |= 1u;
...
DW$13	.dwtag  DW_TAG_variable, DW_AT_name("L$1"), DW_AT_symbol_name("L$1")
	...
	.dwattr DW$13, DW_AT_location[DW_OP_reg16]
        MOVZ      AR7,AL                ; |172| 
	.dwpsn	"VFD.c",176,2
        MOVL      XAR5,#_GpioDataRegs   ; |176| 
        OR        *+XAR5[5],#0x0400     ; |176| 
	.dwpsn	"VFD.c",177,2
        OR        *+XAR5[3],#0x0080     ; |177| 
	.dwpsn	"VFD.c",178,2
        MOVB      ACC,#10
        ADDL      ACC,XAR5
        MOVL      XAR4,ACC              ; |178| 
        OR        *+XAR4[0],#0x0001     ; |178| 
	.dwpsn	"VFD.c",179,2
        MOVW      DP,#_GpioDataRegs+3
        OR        @_GpioDataRegs+3,#0x0400 ; |179| 
	.dwpsn	"VFD.c",180,2
        MOVB      ACC,#12
        ADDL      ACC,XAR5
        MOVL      XAR4,ACC              ; |180| 
        OR        *+XAR4[0],#0x0001     ; |180| 
	.dwpsn	"VFD.c",183,6
        MOVB      XAR6,#7
        MOVB      AH,#7                 ; |183| 
L1:    
...
;***	-----------------------g2:
;*** 185	-----------------------    *(&GpioDataRegs+5L) |= 0x400u;
;*** 186	-----------------------    if ( CrlReg&1<<Cnt ) goto g4;
	.dwpsn	"VFD.c",185,3
        OR        @_GpioDataRegs+5,#0x0400 ; |185| 
	.dwpsn	"VFD.c",186,3
        MOVB      AL,#1                 ; |186| 
        MOV       T,AH                  ; |186| 
        LSL       AL,T                  ; |186| 
...
;*** 192	-----------------------    *(&GpioDataRegs+5L) |= 0x40u;
;*** 192	-----------------------    goto g5;
	.dwpsn	"VFD.c",192,4
        OR        @_GpioDataRegs+5,#0x0040 ; |192| 
        BF        L3,UNC                ; |192| 
        ; branch occurs ; |192| 
...
;***	-----------------------g4:
;*** 188	-----------------------    *(&GpioDataRegs+3L) |= 0x40u;
	.dwpsn	"VFD.c",188,4
        OR        @_GpioDataRegs+3,#0x0040 ; |188| 
DW$L$_VfdCtlRegInit$4$E:
L3:    
DW$L$_VfdCtlRegInit$5$B:
;***	-----------------------g5:
;*** 194	-----------------------    *(&GpioDataRegs+3L) |= 0x400u;
;*** 183	-----------------------    --Cnt;
;*** 183	-----------------------    if ( (--L$1) != (-1) ) goto g2;
	.dwpsn	"VFD.c",194,3
        OR        @_GpioDataRegs+3,#0x0400 ; |194| 
	.dwpsn	"VFD.c",183,24
        ADDB      AH,#-1
	.dwpsn	"VFD.c",183,14
        BANZ      L1,AR6--              ; |183| 
...
;*** 197	-----------------------    ((volatile unsigned *)C$1)[10] |= 1u;
...
DW$14	.dwtag  DW_TAG_loop
	.dwattr DW$14, DW_AT_name("C:\21tracer_monitor\main\VFD.asm:L1:1:1612335235")
	.dwattr DW$14, DW_AT_begin_file("VFD.c")
	.dwattr DW$14, DW_AT_begin_line(0xb7)
	.dwattr DW$14, DW_AT_end_line(0xc3)
...
DW$18	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$7, DW_AT_end_line(0xc8)
...
DW$19	.dwtag  DW_TAG_subprogram, DW_AT_name("VfdInit"), DW_AT_symbol_name("_VfdInit")
	...
	.dwattr DW$19, DW_AT_begin_line(0xc9)
...
;*** 203	-----------------------    ((volatile unsigned *)C$1)[12] |= 1u;
;*** 204	-----------------------    *((volatile struct _GPADAT_BITS *)C$1+5L) |= 0x400u;
;*** 205	-----------------------    *(&GpioDataRegs+5L) |= 0x40u;
;*** 206	-----------------------    *(&GpioDataRegs+5L) |= 0x80u;
;*** 207	-----------------------    VfdCtlRegInit(129u);
;*** 208	-----------------------    VfdCtlRegInit(77u);
;*** 208	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
	.dwcfa	0x09, 40, 26
...
DW$20	.dwtag  DW_TAG_variable, DW_AT_name("C$1"), DW_AT_symbol_name("C$1")
	...
	.dwpsn	"VFD.c",203,2
        MOVL      XAR5,#_GpioDataRegs   ; |203| 
        MOVB      ACC,#12
        ADDL      ACC,XAR5
        MOVL      XAR4,ACC              ; |203| 
        OR        *+XAR4[0],#0x0001     ; |203| 
	.dwpsn	"VFD.c",204,2
        OR        *+XAR5[5],#0x0400     ; |204| 
	.dwpsn	"VFD.c",205,2
        MOVW      DP,#_GpioDataRegs+5
        OR        @_GpioDataRegs+5,#0x0040 ; |205| 
	.dwpsn	"VFD.c",206,2
        OR        @_GpioDataRegs+5,#0x0080 ; |206| 
	.dwpsn	"VFD.c",207,2
        MOVB      AL,#129               ; |207| 
        LCR       #_VfdCtlRegInit       ; |207| 
        ; call occurs [#_VfdCtlRegInit] ; |207| 
	.dwpsn	"VFD.c",208,2
        MOVB      AL,#77                ; |208| 
        LCR       #_VfdCtlRegInit       ; |208| 
        ; call occurs [#_VfdCtlRegInit] ; |208| 
	.dwpsn	"VFD.c",209,1
        LRETR
        ; return occurs
	.dwattr DW$19, DW_AT_end_file("VFD.c")
	.dwattr DW$19, DW_AT_end_line(0xd1)
...
DW$21	.dwtag  DW_TAG_subprogram, DW_AT_name("VfdDataLoad"), DW_AT_symbol_name("_VfdDataLoad")
	...
	.dwattr DW$21, DW_AT_begin_line(0xd3)
...
;***************************************************************
_VfdDataLoad:
;*** 221	-----------------------    K$2 = &GpioDataRegs;
;*** 221	-----------------------    ((volatile unsigned *)K$2)[5] |= 0x400u;
;*** 222	-----------------------    ((volatile unsigned *)K$2)[5] |= 0x80u;
;*** 223	-----------------------    *((volatile struct _GPBDAT_BITS *)K$2+10L) |= 1u;
;*** 224	-----------------------    ((volatile unsigned *)K$2)[3] |= 0x400u;
;*** 225	-----------------------    *((volatile struct _GPBDAT_BITS *)K$2+12L) |= 1u;
;***  	-----------------------    #pragma MUST_ITERATE(8, 8, 8)
;***  	-----------------------    #pragma LOOP_FLAGS(4096u)
;***  	-----------------------    K$26 = (char *)(&FontData);
;*** 217	-----------------------    ConverData = 0;
...
DW$35	.dwtag  DW_TAG_variable, DW_AT_name("K$2"), DW_AT_symbol_name("K$2")
	...
	.dwattr DW$35, DW_AT_location[DW_OP_reg4]
        MOVL      XAR5,XAR4             ; |212| 
	.dwpsn	"VFD.c",221,2
        MOVL      XAR7,#_GpioDataRegs   ; |221| 
        OR        *+XAR7[5],#0x0400     ; |221| 
	.dwpsn	"VFD.c",222,2
        OR        *+XAR7[5],#0x0080     ; |222| 
	.dwpsn	"VFD.c",223,2
        MOVB      ACC,#10
        ADDL      ACC,XAR7
        MOVL      XAR6,ACC              ; |223| 
        OR        *+XAR6[0],#0x0001     ; |223| 
	.dwpsn	"VFD.c",224,2
        OR        *+XAR7[3],#0x0400     ; |224| 
	.dwpsn	"VFD.c",225,2
        MOVB      ACC,#12
        ADDL      ACC,XAR7
        MOVL      XAR6,ACC              ; |225| 
        OR        *+XAR6[0],#0x0001     ; |225| 
        MOVL      XAR7,#_FontData
	.dwpsn	"VFD.c",217,6
        SETC      SXM
        MOV       PL,#0                 ; |217| 
...
;***	-----------------------g4:
;*** 233	-----------------------    ConverData |= (U$28>>y&1)<<6-y;
;*** 232	-----------------------    --y;
;*** 232	-----------------------    if ( (--L$3) != (-1) ) goto g4;
	.dwpsn	"VFD.c",233,5
        MOVB      XAR0,#6               ; |233| 
        MOV       T,AL                  ; |233| 
        SUB       AR0,AL                ; |233| 
...
;***	-----------------------g6:
;*** 237	-----------------------    K$2 = &GpioDataRegs+5L;
;*** 237	-----------------------    *(volatile unsigned *)K$2 |= 0x400u;
;*** 238	-----------------------    if ( ConverData&1<<x ) goto g8;
	.dwpsn	"VFD.c",237,5
        MOVL      XAR0,#_GpioDataRegs+5 ; |237| 
        OR        *+XAR0[0],#0x0400     ; |237| 
	.dwpsn	"VFD.c",238,5
        MOVB      AH,#1                 ; |238| 
        MOV       T,AL                  ; |238| 
        LSL       AH,T                  ; |238| 
...
;*** 244	-----------------------    *(volatile unsigned *)K$2 |= 0x40u;
;*** 244	-----------------------    goto g9;
	.dwpsn	"VFD.c",244,6
        OR        *+XAR0[0],#0x0040     ; |244| 
        BF        L9,UNC                ; |244| 
        ; branch occurs ; |244| 
...
;***	-----------------------g8:
;*** 240	-----------------------    *(&GpioDataRegs+3L) |= 0x40u;
	.dwpsn	"VFD.c",240,6
        MOVW      DP,#_GpioDataRegs+3
        OR        @_GpioDataRegs+3,#0x0040 ; |240| 
DW$L$_VfdDataLoad$8$E:
L9:    
DW$L$_VfdDataLoad$9$B:
;***	-----------------------g9:
;*** 246	-----------------------    K$2 = &GpioDataRegs;
;*** 246	-----------------------    ((volatile unsigned *)K$2)[3] |= 0x400u;
;*** 235	-----------------------    --x;
;*** 235	-----------------------    if ( (--L$4) != (-1) ) goto g6;
	.dwpsn	"VFD.c",246,5
        MOVL      XAR0,#_GpioDataRegs   ; |246| 
        OR        *+XAR0[3],#0x0400     ; |246| 
	.dwpsn	"VFD.c",235,23
        ADDB      AL,#-1
	.dwpsn	"VFD.c",235,15
        BANZ      L7,AR6--              ; |235| 
...
;*** 252	-----------------------    *((volatile struct _GPBDAT_BITS *)K$2+10L) |= 1u;
;*** 253	-----------------------    ((volatile unsigned *)K$2)[5] |= 0x400u;
;*** 253	-----------------------    return;
	.dwpsn	"VFD.c",252,2
        MOVB      ACC,#10
        ADDL      ACC,XAR0
        MOVL      XAR4,ACC              ; |252| 
        OR        *+XAR4[0],#0x0001     ; |252| 
	.dwpsn	"VFD.c",253,2
        OR        *+XAR0[5],#0x0400     ; |253| 
	.dwpsn	"VFD.c",255,1
	.dwcfa	0x1d, -4
        MOVL      XAR1,*--SP
	.dwcfa	0x1d, -2
...
DW$36	.dwtag  DW_TAG_loop
	.dwattr DW$36, DW_AT_name("C:\21tracer_monitor\main\VFD.asm:L4:1:1612335235")
	.dwattr DW$36, DW_AT_begin_file("VFD.c")
	.dwattr DW$36, DW_AT_begin_line(0xe4)
	.dwattr DW$36, DW_AT_end_line(0xfb)
...
DW$39	.dwtag  DW_TAG_loop
	.dwattr DW$39, DW_AT_name("C:\21tracer_monitor\main\VFD.asm:L5:2:1612335235")
	.dwattr DW$39, DW_AT_begin_file("VFD.c")
	.dwattr DW$39, DW_AT_begin_line(0xe6)
	.dwattr DW$39, DW_AT_end_line(0xf9)
...
DW$43	.dwtag  DW_TAG_loop
	.dwattr DW$43, DW_AT_name("C:\21tracer_monitor\main\VFD.asm:L6:3:1612335235")
	.dwattr DW$43, DW_AT_begin_file("VFD.c")
	.dwattr DW$43, DW_AT_begin_line(0xe8)
	.dwattr DW$43, DW_AT_end_line(0xe9)
...
DW$45	.dwtag  DW_TAG_loop
	.dwattr DW$45, DW_AT_name("C:\21tracer_monitor\main\VFD.asm:L7:3:1612335235")
	.dwattr DW$45, DW_AT_begin_file("VFD.c")
	.dwattr DW$45, DW_AT_begin_line(0xeb)
	.dwattr DW$45, DW_AT_end_line(0xf7)
...
DW$49	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$21, DW_AT_end_line(0xff)
...
DW$50	.dwtag  DW_TAG_subprogram, DW_AT_name("VFDPrintf"), DW_AT_symbol_name("_VFDPrintf")
	...
	.dwattr DW$50, DW_AT_begin_line(0x101)
...
_VFDPrintf:
;*** 262	-----------------------    C$1 = &Buff[0];
;*** 262	-----------------------    vsprintf(C$1, (char *)Form, (char *)(&Form));
;*** 264	-----------------------    VfdDataLoad(C$1);
;*** 264	-----------------------    return;
	.dwcfa	0x1d, -2
	.dwcfa	0x1c, 26, 0
...
DW$54	.dwtag  DW_TAG_variable, DW_AT_name("C$1"), DW_AT_symbol_name("C$1")
	...
	.dwpsn	"VFD.c",262,5
        ...
        MOVL      *-SP[2],XAR4          ; |262| 
        MOVL      XAR5,*-SP[8]          ; |262| 
        MOVL      XAR3,#_Buff$1$0       ; |262| 
        MOVL      XAR4,XAR3             ; |262| 
        LCR       #_vsprintf            ; |262| 
        ; call occurs [#_vsprintf] ; |262| 
	.dwpsn	"VFD.c",264,5
        MOVL      XAR4,XAR3             ; |264| 
        LCR       #_VfdDataLoad         ; |264| 
        ; call occurs [#_VfdDataLoad] ; |264| 
	.dwpsn	"VFD.c",266,1
        SUBB      SP,#2
	.dwcfa	0x1d, -4
        MOVL      XAR3,*--SP
	...
	.dwattr DW$50, DW_AT_end_line(0x10a)
